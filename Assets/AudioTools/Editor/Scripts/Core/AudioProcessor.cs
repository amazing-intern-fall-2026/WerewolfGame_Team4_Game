...
namespace AudioTool
{
    ...
    public static class AudioProcessor
    {
        ...
        public static async Task<AudioClip> CreateClipFromSamples(float[] samples, int channels, int frequency, string name = "ProcessedAudio")
        {
            ...
            return await CreateClipFromSamples(samples, channels, frequency, name, tempPath);
        }

        internal static async Task<AudioClip> CreateClipFromSamples(float[] samples, int channels, int frequency, string name, string tempPath)
        {
            if (samples == null || samples.Length == 0)
            {
        ...
        /// <param name="frequency">Clip sample rate in hertz.</param>
        /// <returns>The nearest per-channel sample-frame index.</returns>
        ...
        /// </summary>
        /// <param name="sample">Per-channel sample-frame index.</param>
        /// <param name="frequency">Clip sample rate in hertz.</param>
        /// <returns>The corresponding playback time in seconds.</returns>
        ...
        /// </summary>
        /// <param name="clip">Clip whose readable sample data should be copied.</param>
        /// <returns>
        /// A new array containing interleaved channel samples, or <c>null</c> when the clip is
        /// missing or its data cannot be read.
        /// </returns>
