...
namespace AudioTool
{
    ...
    public static class AudioHeaderReader
    {
        ...
        public class AudioHeaderInfo
        {
            ...
            /// <summary>Sample frames per second, in hertz.</summary>
            public int SampleRate { get; set; }

            /// <summary>Bit depth of each sample in uncompressed source data.</summary>
        ...
        /// </summary>
        /// <param name="filePath">Absolute path to a WAV, AIFF, AIFC, or OGG Vorbis file.</param>
        /// <returns>The parsed header metadata, or <c>null</c> when the file is missing, unsupported, or malformed.</returns>
