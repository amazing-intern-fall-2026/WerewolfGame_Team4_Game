...
namespace AudioTool
{
    ...
    public class AudioWaveformRenderer
    {
        ...
        /// </summary>
        /// <param name="normalized">Position across the waveform; values outside 0 to 1 are clamped.</param>
        /// <param name="totalSamples">Number of per-channel sample frames represented by the waveform.</param>
        /// <returns>The nearest zero-based sample-frame index.</returns>
        ...
        /// </summary>
        /// <param name="sample">Zero-based sample-frame index.</param>
        /// <param name="totalSamples">Number of per-channel sample frames represented by the waveform.</param>
        /// <returns>A clamped position from 0 at the start to 1 at the end.</returns>
        ...
        /// </summary>
        /// <param name="pixelX">Horizontal pixel coordinate relative to the waveform texture.</param>
        /// <param name="width">Waveform texture width in pixels.</param>
        /// <returns>A clamped position from 0 at the left edge to 1 at the right edge.</returns>
        ...
        /// <param name="normalized">Position across the waveform; values outside 0 to 1 are clamped.</param>
        /// <param name="width">Waveform texture width in pixels.</param>
        /// <returns>The nearest horizontal pixel coordinate.</returns>
